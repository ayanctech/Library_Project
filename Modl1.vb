...
Module Modl1
    ...
    Public Sub connect()
        ...
        conn.ConnectionString = "Data Source=(LocalDB)\v11.0;AttachDbFilename=|%LOCALAPPDATA%|\ACTECH\libdb2.mdf;Integrated Security=True".Replace("|%LOCALAPPDATA%|", Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData))
        'conn.ConnectionString = ConfigurationManager.ConnectionStrings("libprj.My.MySettings.libdbConnectionString").ConnectionString
        Try
            conn.Open()
