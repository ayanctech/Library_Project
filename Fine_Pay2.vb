...
Public Class Fine_Pay2
    ...
    Private Sub btnpy_Click(sender As Object, e As EventArgs) Handles btnpy.Click
        ...
        Dim str As String
        str = "UPDATE tchertbl SET Fine='" & val & "',No_of_Books='" & val & "',Dt1='" & Date.Now & "',Dt2='" & Date.Now & "',Bk1='" & val & "',Bk2='" & val & "' WHERE Username='" & lblunm.Text & "' "
    ...
    Private Sub Fine_Pay2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        connect()
    End Sub
End Class